...
export default function BonusPerks() {
  ...
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-semibold text-gray-900">Bonus perks</h2>
        ...
        {perks.map((perk, index) => (
          <div key={index} className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            ...
            <a 
              ...
              className="block w-full text-center px-4 py-3 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-100 transition"
            >
              Invest {perk.amount}
            </a>
          </div>
